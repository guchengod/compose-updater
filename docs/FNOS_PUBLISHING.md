...
|---|---|---|
| 全新安装并出现桌面入口 | 待验证 | 待验证 |
| 从上一版本升级并保留配置 | v0.6.3 → v0.6.4 通过（2026-07-23） | 待验证 |
| 打开运行中心和读取历史 | 通过（2026-07-23） | 待验证 |
| 选择扫描目录和跳过目录 | 通过（2026-07-23） | 待验证 |
| 保存配置并重启服务 | 通过（2026-07-23） | 待验证 |
| Registry 代理测试 | 通过，401 被正确识别为 Registry 认证响应（2026-07-23） | 待验证 |
| 立即运行并识别自定义 Compose 项目名 | 通过，识别 `myflatnas`（2026-07-23） | 待验证 |
